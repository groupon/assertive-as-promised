# assertive-as-promised should be 100% backward-compatible with assertive
# hand-copied and modified from the assertive repo
# changes: 1) require '../' instead of '../lib/assertive'
#          2) change instances of "->, " to "(->), " to make Coffee 1.x happy
# TODO: automate this re-use?
